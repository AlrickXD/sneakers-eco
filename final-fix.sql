-- =====================================================
-- CORRECTION FINALE : Solution simple et directe
-- =====================================================
...
CREATE POLICY "products_allow_all" ON products FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "variants_allow_all" ON product_variants FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
-- =====================================================
-- NOTES :
-- - Solution directe sans références à des colonnes inexistantes
