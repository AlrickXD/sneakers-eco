...
export default function ProductDetailPage() {
  ...
  const handleAddToCart = async () => {
    ...
    if (profile?.role === 'vendeur') {
      console.log('Vendeur détecté - ajout au panier bloqué')
      return
    }
                ...
                {availableSizes.map(size => {
                  ...
                  return (
                    <button
                      ...
                      disabled={!variant}
                      className={`w-12 h-10 border rounded-lg text-sm font-medium transition-all ${
                        selectedSize === size
              ...
              <div className="space-y-4">
                {profile?.role === 'vendeur' ? (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                    <span className="font-semibold text-blue-800">Mode consultation vendeur</span>
