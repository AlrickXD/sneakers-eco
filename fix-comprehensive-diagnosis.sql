-- =====================================================
-- DIAGNOSTIC CORRIGÉ : Structure DB actuelle
-- =====================================================
...
-- Vérifier les colonnes disponibles dans profiles
SELECT
  'Colonnes dans profiles:' as info,
  column_name,
  data_type
...
-- Vérifier le profil utilisateur (colonnes disponibles)
SELECT
...
-- =====================================================
-- NOTES :
-- - Script corrigé pour la structure DB actuelle
-- - Ne fait pas référence à la colonne email manquante
-- - Test complet des permissions d'insertion
